...
// 			r.tryPlay(r.game.GetPlayer1(), string(p1Msg))
// 		case p2Msg := <-r.p2Chann:
// 			fmt.Printf("player 2 send this message: %s \n", string(p2Msg))
// 			r.tryPlay(r.game.GetPlayer2(), string(p2Msg))
// 		}
// 	}
// }
...
// 	r.send(r.game.GetPlayer1(), data)
// 	return r.send(r.game.GetPlayer2(), data)
// }
